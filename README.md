...
5. Search for `starter-` to capture prefixed handles.

OR

* Search for: `'starter'` and replace with: `'megatherium-is-awesome'`
* Search for: `starter_` and replace with: `megatherium_is_awesome_`
